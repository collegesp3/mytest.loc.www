        ...
        <form class="register" style="display: none">
            ...
            <div class="passwords" id="password_label">
                ...
                <label class="placeinput" id="second_password">
                    ...
                    <span class="tooltip">
                        <p> Должны совпадать </p>
                    </span>
                </label>
            </div>

            <div class="user-type" style="width: 89%; display: flex; padding-left: 1px;">
                <label class="container" id="individual">
                    <p> Частное лицо</p> <input type="radio" name="user_type"> <span class="checkmark"></span>
                </label>
                <label class="container" id="entities">
                    <p> Юридическое лицо</p> <input type="radio" name="user_type"> <span class="checkmark"></span>
                </label>
            </div>
            <label class="container" id="personal_data">
                <p>Согласен на <a href="#">обработку персональных данных *</a></p> <input type="checkbox"> <span class="checkmark"></span>
            </label>

            <label class="container" id="mailing">
                <p>Я хочу получать рассылку об акциях и новостях</p> <input type="checkbox"> <span class="checkmark"></span>
            </label>
